...
public class Edit extends JLabel{
	private static Edit addLabel;
	...
	private void setComponents() {
		...
		label1.setBounds(110,300,300,90);
		label1.setForeground(Color.WHITE);
		add(label1);
		
		label2 = new JLabel("Edit pet profile");
		label2.setFont(new Font("Segoe UI Light",Font.PLAIN, 20));
		label2.setBounds(145,300,300,200);
